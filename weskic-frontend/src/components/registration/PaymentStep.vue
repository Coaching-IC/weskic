...
<!--    </div>-->
    ...
    <div id="has-not-paid" v-else class="columns">
      <div>
        <h2 class="subtitle">Nous ne proposons plus le paiement en ligne ou à la boutique AGEPoly car nous sommes en dehors de la période d'inscription.</h2>
        <h1 class="subtitle"><strong>Pour effectuer le paiement tu peux t'adresser à notre Moneycoach Maxime Lestiboudois</strong></h1>
        <div class="columns">
          <h2 class="column"><a href="mailto:maxime.lestiboudois@epfl.ch">maxime.lestiboudois@epfl.ch</a></h2>
          <h2 class="column"><a href="https://t.me/MaxLesti">@MaxLesti sur Telegram</a></h2>
        </div>
      </div>
    </div>
